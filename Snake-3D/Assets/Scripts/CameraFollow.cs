...
namespace SnakeGame
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        [SerializeField]
        private float zFollowDistance = -8f;

        [SerializeField]
        private float yFollowDistance = 2.5f;

        [SerializeField]
        private Vector3 cameraEulerAngle = new Vector3(15, 0, 0);
        ...
        void LateUpdate()
        {
            ...
            transform.position =
                new Vector3(playerVector.x, playerVector.y, playerVector.z) + rotation * direction;
