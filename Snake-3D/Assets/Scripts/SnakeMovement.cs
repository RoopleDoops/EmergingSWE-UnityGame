...
namespace SnakeGame
{
    public class SnakeMovement : MonoBehaviour
    {
        ...
        [SerializeField]
        private float inputSensitivity = 5.0f; // Controls how fast direction change occurs

        [SerializeField]
        private float maxTiltAroundX = 30.0f; // maximum tilt x

        [SerializeField]
        private float maxTiltAroundY = 30.0f; // maximum tilt y

        [SerializeField]
        private float moveSpeedDefault = 5f;
        private float moveSpeed;
        public float moveSpeedForTest; //for testing purposes

        [SerializeField]
        private float increaseSpeedAmount = 0.25f;
        ...
        void Update()
        {
            ...
            if (segmentUpdateTime > 0f)
                segmentUpdateTime -= Time.deltaTime;
            else
